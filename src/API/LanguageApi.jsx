...
export const getLanguageById = async (Id) => {
  try {
    const response = await axios.get(`${API_BASE_URL}/language/${Id}`, {
      headers,
    });
...
// ===================Edit Language================D
export const updateLanguageById = async (formData) => {
  try {
    const response = await axios.put(`${API_BASE_URL}/language`, formData, {
      headers,
...
export const deleteLanguage = async (Id) => {
  try {
    const response = await axios.delete(`${API_BASE_URL}/language/${Id}`, {
      headers,
    });
    if (response.data.status === true) {
      toast(response.data.message); // Toast success message
