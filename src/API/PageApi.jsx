...
// ----------------------getPagesbyId----------------
export const getPagesById = async (Id) => {
  try {
...
// ===================Edit Pages================D
export const updatePagesById = async (formData) => {
  try {
    const response = await axios.put(`${API_BASE_URL}/page`, formData, {
      headers,
...
// ------------------------Add Pages---------------------
export const AddPages = async (formData) => {
  try {
