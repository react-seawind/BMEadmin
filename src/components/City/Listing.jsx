...
import { getAllCity, deleteCity } from '../../API/CityAPI';
...
const CityListing = () => {
  ...
  return (
    <div>
      <Breadcrumb pageName="City Listing" />
